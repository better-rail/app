// Station IDs and Hebrew labels match apps/server/src/data/stations.ts.
// Flair names are intentionally short, lowercase transliterations.
export const stations = [
  ...
  {
    id: "1250",
    name: "migdal haemek kfar barukh",
  ...
  {
    id: "4300",
    name: "shomron tayyiba",
    hebrew: "שומרון - טייבה",
  },
  {
    id: "4310",
    name: "tira kokhav yair",
