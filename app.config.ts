...
export default ({ config }: ConfigContext): ExpoConfig => ({
	...
	ios: {
		...
		infoPlist: {
			...
			NSCalendarsFullAccessUsageDescription:
				"We need calendar access to add train rides.",
			NSCalendarsUsageDescription:
				"We need calendar access to add train rides.",
			NSContactsUsageDescription:
				"We need access to your contacts to import and manage contacts within our app.",
			NSRemindersFullAccessUsageDescription:
				"We need full access to reminders to create alerts for your train rides.",
	...
	plugins: [
		...
		[
			"expo-font",
			{
				ios: { fonts: HEEBO_FONTS_IOS },
				android: { fonts: [HEEBO_FONT_ANDROID] },
			},
		],
	...
	extra: {
		eas: {
			projectId:
				process.env.EAS_PROJECT_ID ?? "b7819f45-8466-4c11-8628-3539099e6c78",
		},
		appleTeamId: APPLE_TEAM_ID,
		appGroup: APP_GROUP,
